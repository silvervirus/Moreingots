...
namespace MoreIngots.Packed
{
    ...
    public static class PMISCopper
    {
        
        
        public static PrefabInfo Info { get; } = PrefabInfo.WithTechType("MISCopper", " Stacked Copper Ingot", "Au. Compressed x2 CopperIngot.")
            // set the icon to that of the vanilla locker:
            .WithIcon(RamuneLib.Utils.ImageUtils.GetSprite("MISCopper"));
        ...
        CloneTemplate lockerClone = new CloneTemplate(Info, TechType.PlasteelIngot);
            ...
            _ = prefab.SetRecipe(new RecipeData()
            {
                ...
                { new CraftData.Ingredient(PMICopper.techType, 10),
