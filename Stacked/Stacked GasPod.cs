...
namespace MoreIngots.Packed
{
    ...
    public static class PMISPod
    {
        
        
        public static PrefabInfo Info { get; } = PrefabInfo.WithTechType("MISPod", " Stacked GasPod", "Au. Compressed x2 GasPod.")
        ...
        CloneTemplate lockerClone = new CloneTemplate(Info, TechType.PlasteelIngot);
            ...
            _ = prefab.SetRecipe(new RecipeData()
            {
                ...
                { new CraftData.Ingredient(PMIPod.techType, 10),
