...
namespace MoreIngots.Packed
{
    ...
    public static class PMISJelly
    {
        
        
        public static PrefabInfo Info { get; } = PrefabInfo.WithTechType("MISJelly", " Stacked JellyMushroom", "Au. Compressed x2 JellyMushroom.")
        ...
        CloneTemplate lockerClone = new CloneTemplate(Info, TechType.JellyPlant);
            ...
            _ = prefab.SetRecipe(new RecipeData()
            {
                ...
                { new CraftData.Ingredient(PMIJelly.techType, 10),
