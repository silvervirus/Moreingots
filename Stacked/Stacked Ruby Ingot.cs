...
namespace MoreIngots.Packed
{
    ...
    public static class PMISRuby
    {
        
        
        public static PrefabInfo Info { get; } = PrefabInfo.WithTechType("MISRuby", " Stacked Ruby Ingot", "Au. Compressed x2 Ruby Ingot.")
        ...
        CloneTemplate lockerClone = new CloneTemplate(Info, TechType.PlasteelIngot);
            ...
            _ = prefab.SetRecipe(new RecipeData()
            {
                ...
                { new CraftData.Ingredient(PMIRuby.techType, 10),
