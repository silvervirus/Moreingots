...
namespace MoreIngots.Packed
{
    ...
    public static class PMISCrash
    {
        
        
        public static PrefabInfo Info { get; } = PrefabInfo.WithTechType("MISCrash", " Stacked Crashpowder Ingot", "S. Compressed x2 Crashpowder Ingot.")
        ...
        CloneTemplate lockerClone = new CloneTemplate(Info, TechType.PlasteelIngot);
            ...
            _ = prefab.SetRecipe(new RecipeData()
            {
                ...
                { new CraftData.Ingredient(PMICrash.techType, 10),
