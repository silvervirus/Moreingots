...
namespace MoreIngots.Packed
{
    ...
    public class MISUraninite
    {
       public static TechType techType;
        
        public static void Patch()
        {
            PMISUraninite.Register();
        }
    }

    public static class PMISUraninite
    {
        
        
        public static PrefabInfo Info { get; } = PrefabInfo.WithTechType("MISUraninite", " Stacked Uraninite Ingot", "Au. Compressed x2 Uraninite Ingot.")
            // set the icon to that of the vanilla locker:
            .WithIcon(RamuneLib.Utils.ImageUtils.GetSprite("MISUraninite"));
        ...
        CloneTemplate lockerClone = new CloneTemplate(Info, TechType.PlasteelIngot);
            ...
            _ = prefab.SetRecipe(new RecipeData()
            {
                ...
                { new CraftData.Ingredient(PMIUraninite.techType, 10),
