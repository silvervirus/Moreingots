...
namespace MoreIngots.Packed
{
    ...
    public class MISSilicone
    {
       public static TechType techType;
        
        public static void Patch()
        {
            PMISSilicone.Register();
        }
    }

    public static class PMISSilicone
    {
        
        
        public static PrefabInfo Info { get; } = PrefabInfo.WithTechType("MISSilicone", " Stacked Silicone", "Silicone. Compressed x2 Silicone.")
        ...
        CloneTemplate lockerClone = new CloneTemplate(Info, TechType.PlasteelIngot);
            ...
            lockerClone.ModifyPrefab += go =>
            {
                ...
                if (renderer != null)
                {
                    renderer.materials[0].mainTexture = RamuneLib.Utils.ImageUtils.GetTexture("MISSIText");
                    renderer.materials[0].SetTexture("_SpecTex", RamuneLib.Utils.ImageUtils.GetTexture("MISSIText"));
                }
                else
                {
            ...
            _ = prefab.SetRecipe(new RecipeData()
            {
                ...
                { new CraftData.Ingredient(PMISilicone.techType, 10),
