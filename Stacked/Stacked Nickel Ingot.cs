...
namespace MoreIngots.Packed
{
    ...
    public static class PMISNickel
    {
        
        
        public static PrefabInfo Info { get; } = PrefabInfo.WithTechType("MISNickel", " Stacked Nickel Ingot", "Ni. Compressed x2 Nickel Ingot.")
            // set the icon to that of the vanilla locker:
            .WithIcon(RamuneLib.Utils.ImageUtils.GetSprite("MISNickel"));
        ...
        CloneTemplate lockerClone = new CloneTemplate(Info, TechType.PlasteelIngot);
            ...
            _ = prefab.SetRecipe(new RecipeData()
            {
                ...
                { new CraftData.Ingredient(PMINickel.techType, 10),
