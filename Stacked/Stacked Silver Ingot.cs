...
namespace MoreIngots.Packed
{
    ...
    public static class PMISSilver
    {
        
        
        public static PrefabInfo Info { get; } = PrefabInfo.WithTechType("MISSilver", " Stacked Silver Ingot", "Au. Compressed x2 Silver Ingot.")
            // set the icon to that of the vanilla locker:
            .WithIcon(RamuneLib.Utils.ImageUtils.GetSprite("MISSilver"));
        ...
        CloneTemplate lockerClone = new CloneTemplate(Info, TechType.PlasteelIngot);
            ...
            _ = prefab.SetRecipe(new RecipeData()
            {
                ...
                { new CraftData.Ingredient(PMISilver.techType, 10),
