...
namespace MoreIngots.Packed
{
    ...
    public class MISPlasteel
    {
       public static TechType techType;
        
        public static void Patch()
        {
            PMISPlasteel.Register();
        }
    }

    public static class PMISPlasteel
    {
        
        
        public static PrefabInfo Info { get; } = PrefabInfo.WithTechType("MISPlasteel", " Stacked Plasteel Ingot", "Au. Compressed x2 Plasteel Ingot.")
        ...
        CloneTemplate lockerClone = new CloneTemplate(Info, TechType.PlasteelIngot);
            ...
            _ = prefab.SetRecipe(new RecipeData()
            {
                ...
                { new CraftData.Ingredient(PMIPlasteel.techType, 10),
