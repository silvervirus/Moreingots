...
namespace MoreIngots.Packed
{
    ...
    public static class PMISGold
    {
        
        
        public static PrefabInfo Info { get; } = PrefabInfo.WithTechType("MISGold", " Stacked Gold Ingot", "Au. Compressed x2 Gold Ingot.")
            // set the icon to that of the vanilla locker:
            .WithIcon(RamuneLib.Utils.ImageUtils.GetSprite("MISGold"));
        ...
        CloneTemplate lockerClone = new CloneTemplate(Info, TechType.PlasteelIngot);
            ...
            _ = prefab.SetRecipe(new RecipeData()
            {
                ...
                { new CraftData.Ingredient(PMIGold.techType, 10),
