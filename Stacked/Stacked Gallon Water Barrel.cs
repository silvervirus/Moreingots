...
namespace MoreIngots.Packed
{
    ...
    public class MIS5GallonWater
    {
       public static TechType techType;
        
        public static void Patch()
        {
            PMIS5GallonWater.Register();
        }
    }

    public static class PMIS5GallonWater
    {
        
        
        public static PrefabInfo Info { get; } = PrefabInfo.WithTechType("MIS5GallonWater", " Stacked 5 Gallon Water", "5GallonWater. Packed Containers x2 5 Gallon Water.")
        ...
        CloneTemplate lockerClone = new CloneTemplate(Info, TechType.FilteredWater);
            ...
            _ = prefab.SetRecipe(new RecipeData()
            {
                ...
                { new CraftData.Ingredient(PMIGallonWater.techType, 10),
