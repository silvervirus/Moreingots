...
//*
    ...
    public static class PMISulphur
    {
        
        
        public static PrefabInfo Info { get; } = PrefabInfo.WithTechType("MISulphur", "Packed Sulphur Ingot", "S. Compressed Sulphur Ingot.")
            // set the icon to that of the vanilla locker:
            .WithIcon(RamuneLib.Utils.ImageUtils.GetSprite("MISulphur"));
        ...
        CloneTemplate lockerClone = new CloneTemplate(Info, TechType.TitaniumIngot);
            ...
            _ = prefab.SetRecipe(new RecipeData()
            {
                ...
                { new CraftData.Ingredient(TechType.Sulphur, 10),
