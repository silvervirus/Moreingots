...
//*
    ...
    public static class PMISilver
    {
        
        
        public static PrefabInfo Info { get; } = PrefabInfo.WithTechType("MISilver ", "Packed Silver  Ingot", "Au. Compressed Silver Ingot.")
        ...
        CloneTemplate lockerClone = new CloneTemplate(Info, TechType.TitaniumIngot);
            ...
            lockerClone.ModifyPrefab += go =>
            {
                ...
                if (renderer != null)
                {
                    renderer.materials[0].mainTexture = RamuneLib.Utils.ImageUtils.GetTexture("SLText");
                    renderer.materials[0].SetTexture("_SpecTex", RamuneLib.Utils.ImageUtils.GetTexture("SLText"));
                }
                else
                {
            ...
            _ = prefab.SetRecipe(new RecipeData()
            {
                ...
                { new CraftData.Ingredient(TechType.Silver, 10),
