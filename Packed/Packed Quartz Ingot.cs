...
//*
    ...
    public static class PMIQuartz
    {
        
        
        public static PrefabInfo Info { get; } = PrefabInfo.WithTechType("MIQuartz", "Packed Quartz Ingot", "Si04. Compressed Quartz Ingot.")
            // set the icon to that of the vanilla locker:
            .WithIcon(RamuneLib.Utils.ImageUtils.GetSprite("MIQuartz"));
        ...
        CloneTemplate lockerClone = new CloneTemplate(Info, TechType.TitaniumIngot);
            ...
            lockerClone.ModifyPrefab += go =>
            {
                ...
                if (renderer != null)
                {
                    renderer.materials[0].mainTexture = RamuneLib.Utils.ImageUtils.GetTexture("QText");
                    renderer.materials[0].SetTexture("_SpecTex", RamuneLib.Utils.ImageUtils.GetTexture("QText"));
