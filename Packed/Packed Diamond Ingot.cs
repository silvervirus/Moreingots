...
//*
    ...
    public static class PMIDiamond
    {
        
        
        public static PrefabInfo Info { get; } = PrefabInfo.WithTechType("MIDiamond", " Packed Diamond Ingot", "Au. Compressed Diamond Ingot.")
            // set the icon to that of the vanilla locker:
            .WithIcon(RamuneLib.Utils.ImageUtils.GetSprite("MIDiamond"));
        ...
        CloneTemplate lockerClone = new CloneTemplate(Info, TechType.TitaniumIngot);
            ...
            lockerClone.ModifyPrefab += go =>
            {
                ...
                if (renderer != null)
                {
                    renderer.materials[0].mainTexture = RamuneLib.Utils.ImageUtils.GetTexture("DDText");
                    renderer.materials[0].SetTexture("_SpecTex", RamuneLib.Utils.ImageUtils.GetTexture("DDText"));
