...
//*
    ...
    public static class PMIGold
    {
        
        
        public static PrefabInfo Info { get; } = PrefabInfo.WithTechType("MIGold", " Packed Gold Ingot", "Au. Compressed Gold Ingot.")
        ...
        CloneTemplate lockerClone = new CloneTemplate(Info, TechType.TitaniumIngot);
            ...
            lockerClone.ModifyPrefab += go =>
            {
                ...
                if (renderer != null)
                {
                    renderer.materials[0].mainTexture = RamuneLib.Utils.ImageUtils.GetTexture("GText");
                    renderer.materials[0].SetTexture("_SpecTex", RamuneLib.Utils.ImageUtils.GetTexture("GText"));
                }
                else
                {
            ...
            _ = prefab.SetRecipe(new RecipeData()
            {
                ...
                { new CraftData.Ingredient(TechType.Gold, 10),
