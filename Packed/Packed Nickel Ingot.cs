...
namespace MoreIngots.Packed
{
    ...
    public static class PMINickel
    {
        
        
        public static PrefabInfo Info { get; } = PrefabInfo.WithTechType("MINickel", "Packed Nickel Ingot", "Ni. Compressed Nickel Ingot.")
        ...
        CloneTemplate lockerClone = new CloneTemplate(Info, TechType.TitaniumIngot);
            ...
            lockerClone.ModifyPrefab += go =>
            {
                ...
                if (renderer != null)
                {
                    renderer.materials[0].mainTexture = RamuneLib.Utils.ImageUtils.GetTexture("NText");
                    renderer.materials[0].SetTexture("_SpecTex", RamuneLib.Utils.ImageUtils.GetTexture("NText"));
                }
                else
                {
            ...
            _ = prefab.SetRecipe(new RecipeData()
            {
                ...
                { new CraftData.Ingredient(TechType.Nickel, 10),
