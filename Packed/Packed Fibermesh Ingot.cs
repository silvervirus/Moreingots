...
{
//*
    public class MIFibermesh
    {
       public static TechType techType;
        
        public static void Patch()
        {
            PMIFibermesh.Register();
        }
    }

    public static class PMIFibermesh
    {
        
        
        public static PrefabInfo Info { get; } = PrefabInfo.WithTechType("MIFibermesh", " Packed Fiber Mesh Ingot", "Au. Compressed Fiber Mesh Ingot.")
        ...
        CloneTemplate lockerClone = new CloneTemplate(Info, TechType.TitaniumIngot);
            ...
            lockerClone.ModifyPrefab += go =>
            {
                ...
                if (renderer != null)
                {
                    renderer.materials[0].mainTexture = RamuneLib.Utils.ImageUtils.GetTexture("TTTText");
                    renderer.materials[0].SetTexture("_SpecTex", RamuneLib.Utils.ImageUtils.GetTexture("TTTText"));
                }
                else
                {
            ...
            _ = prefab.SetRecipe(new RecipeData()
            {
                ...
                { new CraftData.Ingredient(TechType.FiberMesh, 10),
