...
public class DeCompress_Chip
{
       ...
       public static TechType techType;
        ...
        {
            UIDeCompress_Chip.Register();
        }
    }

public static class UIDeCompress_Chip
{


    public static PrefabInfo Info { get; } = PrefabInfo.WithTechType("UIDeCompress_Chip", "DeCompress Chips",
            "This Chip is specially made to Decompress Compressed items.")
        // set the icon to that of the vanilla locker:
        .WithIcon(RamuneLib.Utils.ImageUtils.GetSprite("UIDeCompress_Chip"));
