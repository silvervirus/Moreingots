...
public class PackedLocker
{
    ...
    {
        public static Texture2D HorizontalWallLockersTexture = RamuneLib.Utils.ImageUtils.GetTexture("packeddoor");
        public static Texture2D HorizontalWallLockersspec = RamuneLib.Utils.ImageUtils.GetTexture("packeddoor");
       // public static Texture2D HorizontalWallLockersnorm = RamuneLib.Utils.ImageUtils.GetTexture("submarine_locker_01_normal");
        ...
        public static PrefabInfo Info { get; } = PrefabInfo.WithTechType("MMLocker", "MoreIngots Locker", "Compress or decompress this locker does it all.", "English")
            .WithIcon(RamuneLib.Utils.ImageUtils.GetSprite("packedLocker"));
        ...
        public static void Register()
        {
            ...
            {   
                ...
                var dynamicLocker = obj.AddComponent<global::PackedLocker>();
            ...
            prefab.SetRecipe(new RecipeData()
            {
                ...
                Ingredients = new List<CraftData.Ingredient>()
                {
                    ...
                    new CraftData.Ingredient(UICompress_Chip.techType, 1)
                },
            });
