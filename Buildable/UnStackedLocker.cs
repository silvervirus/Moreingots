...
public class UnStackedLocker
{
   public static TechType techType = BuildableUnstacked.Info.TechType;
        public static void Patch()
        {
            BuildableUnstacked.Register();
        }
    

    public static class BuildableUnstacked
    {
        public static Texture2D HorizontalWallLockersTexture = RamuneLib.Utils.ImageUtils.GetTexture("unstackeddoor");
        public static Texture2D HorizontalWallLockersspec = RamuneLib.Utils.ImageUtils.GetTexture("unstackeddoor");
       // public static Texture2D HorizontalWallLockersnorm = RamuneLib.Utils.ImageUtils.GetTexture("submarine_locker_01_normal");
        ...
        public static PrefabInfo Info { get; } = PrefabInfo.WithTechType("UNSTLocker", "Unstacked Locker", "decompress Stacked Ingots this locker does it all.", "English")
            .WithIcon(RamuneLib.Utils.ImageUtils.GetSprite("UnStackedLocker"));
        ...
        public static void Register()
        {
            ...
            {   
                ...
                {
                    m.mainTexture = BuildableUnstacked.HorizontalLockersTexture;
                ...
                {
                    m.mainTexture = BuildableUnstacked.HorizontalWallLockersTexture;
                ...
                var dynamicLocker = obj.AddComponent<global::UnstackedLocker>();
            ...
            prefab.SetRecipe(new RecipeData()
            {
                ...
                Ingredients = new List<CraftData.Ingredient>()
                {
                    ...
                    new CraftData.Ingredient(UIDeCompress_Chip.techType, 2)
                },
            });
