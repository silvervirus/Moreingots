...
namespace MoreIngots.Unpacked
{
    ...
    public static class PPISGlasss
    {
        
        
        public static PrefabInfo Info { get; } = PrefabInfo.WithTechType("PISGlass", " Unstacked Glass Ingot", "Au. Uncompressed x2 Stacked Glass Ingots.")
        ...
        public static void Register()
        {
            ...
            _ = prefab.SetRecipe(new RecipeData()
            {
                ...
                {
                    new CraftData.Ingredient(PMISGlass.techType ,1)
                },
                LinkedItems = new List<TechType> { PMIGlass.techType, PMIGlass.techType, PMIGlass.techType, PMIGlass.techType, PMIGlass.techType, PMIGlass.techType, PMIGlass.techType, PMIGlass.techType, PMIGlass.techType, PMIGlass.techType }
            });
