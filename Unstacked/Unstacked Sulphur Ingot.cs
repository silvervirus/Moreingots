...
namespace MoreIngots.Unpacked
{
    ...
    public class PISSulphur
    {
        public static TechType techType;
        public static void Patch()
        {
            PPISSulphurs.Register();
        }
    }

    public static class PPISSulphurs
    {
        
        
        public static PrefabInfo Info { get; } = PrefabInfo.WithTechType("PISSulphur", " Unstacked Sulphur Ingot", "Au. Uncompressed x2 Stacked Sulphur Ingots.")
        ...
        public static void Register()
        {
            ...
            _ = prefab.SetRecipe(new RecipeData()
            {
                ...
                {
                    new CraftData.Ingredient(PMISSulphur.techType ,1)
                },
                LinkedItems = new List<TechType> { PMISulphur.techType, PMISulphur.techType, PMISulphur.techType, PMISulphur.techType, PMISulphur.techType, PMISulphur.techType, PMISulphur.techType, PMISulphur.techType, PMISulphur.techType, PMISulphur.techType }
            });
