...
namespace MoreIngots.Unpacked
{
    ...
    public static class PPISCrashs
    {
        
        
        public static PrefabInfo Info { get; } = PrefabInfo.WithTechType("PISCrash", " Unstacked Crashpowder Ingot", "Au. Uncompressed x2 Stacked Crashpowder Ingots.")
            // set the icon to that of the vanilla locker:
            .WithIcon(RamuneLib.Utils.ImageUtils.GetSprite("MISCrash"));
        ...
        public static void Register()
        {
            ...
            _ = prefab.SetRecipe(new RecipeData()
            {
                ...
                {
                    new CraftData.Ingredient(PMISCrash.techType ,1)
                },
                LinkedItems = new List<TechType> { PMICrash.techType, PMICrash.techType, PMICrash.techType, PMICrash.techType, PMICrash.techType, PMICrash.techType, PMICrash.techType, PMICrash.techType, PMICrash.techType, PMICrash.techType }
            });
