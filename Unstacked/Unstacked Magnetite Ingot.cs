...
namespace MoreIngots.Unpacked
{
    ...
    public class PISMagnetite
    {
        public static TechType techType;
        public static void Patch()
        {
            PPISMagnetites.Register();
        }
    }

    public static class PPISMagnetites
    {
        
        
        public static PrefabInfo Info { get; } = PrefabInfo.WithTechType("PISMagnetite", " Unstacked Magnetite Ingot", "Fe304. Uncompressed x2  Stacked Magnetite Ingots.")
        ...
        public static void Register()
        {
            ...
            _ = prefab.SetRecipe(new RecipeData()
            {
                ...
                {
                    new CraftData.Ingredient(PMISMagnetite.techType ,1)
                },
                LinkedItems = new List<TechType> { PMIMagnetite.techType, PMIMagnetite.techType, PMIMagnetite.techType, PMIMagnetite.techType, PMIMagnetite.techType, PMIMagnetite.techType, PMIMagnetite.techType, PMIMagnetite.techType, PMIMagnetite.techType, PMIMagnetite.techType }
            });
